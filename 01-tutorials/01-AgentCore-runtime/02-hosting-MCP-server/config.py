...
def cleanup():
    ...
    for agent_k in agents:
        ...
        try:
            ...
            print("Failed to clean up bucket")
        try:
            codebuild_cleanup(codebuild_project)
            print(f"Codebuild: {codebuild_project}, deleted")
        except:
            print("Failed to clean up codebuild")
        try:
            clean_agent(agent_arn)
            print(f"Agent: {agent_arn}, deleted")
        except:
            print("Failed to clean up agent")
        try:
            clean_ecr(ecr_repository)
            print(f"ECR: {ecr_repository}, deleted")
        except:
            print("Failed to clean up ecr")
        try:
            clean_roles(agent_role, codebuild_role)
            print("Roles for agent and codebuild, deleted")
        except:
            print("Failed to clean up roles")
